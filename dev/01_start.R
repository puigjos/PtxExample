...
golem::fill_desc(
  pkg_name = "PtxExample", # The Name of the package containing the App 
  pkg_title = "PtxGeneration Example", # The Title of the package containing the App 
  pkg_description = "PKG_DESC.", # The Description of the package containing the App 
  author_first_name = "Josep", # Your First Name
  author_last_name = "Puig Sallés",  # Your Last Name
  author_email = "puigjos@gmail.com",      # Your Email
